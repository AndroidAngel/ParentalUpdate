package com.teamandroidangel.parentalupdate;
...
/**
 * Created by iamangelauditor on 11/01/2018.
 */
...
public class DestinationsAdapter extends RecyclerView.Adapter<DestinationsAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mWaves =  view.findViewById(R.id.waves);
            mVisits = view.findViewById(R.id.visits);
            mFriend1 =  view.findViewById(R.id.friend1);
            mFriend2 = view.findViewById(R.id.friend2);
            mFriend3 = view.findViewById(R.id.friend3);
        }
    }
